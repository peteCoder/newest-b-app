...
def card_list(request):
    ...
    cards = Card.objects.filter(user=request.user).order_by("-pk")
...
def send_payment_transfer_confirmation_from_user(request):
    if request.method == 'POST' and request.user.is_authenticated:
        ...
        send_transaction_mail(to_email=request.user.email, subject="Request to confirm payments", message="The request to to confirm payment is processing. We will attend to it as soon as possible.")
